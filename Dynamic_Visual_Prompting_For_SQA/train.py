...
def get_args_parser():
    ...
    parser.add_argument('--insert_layer', default=0, type=int, help='the placement of DVP')

    parser.add_argument('--kab_app', action='store_true', help='turn on kab-app')
...
def main(args):
    ...
    if args.kab_app:
        dataset_eval = ScienceQADataSet(args, 'val', args.llama_model_path, args.max_seq_len)
        print(dataset_eval)
        ...
        data_loader_eval = torch.utils.data.DataLoader(
            dataset_eval, sampler=sampler_val,
            batch_size=16,
            num_workers=args.num_workers,
            pin_memory=args.pin_mem,
            drop_last=True,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            model, data_loader_train, data_loader_eval,
