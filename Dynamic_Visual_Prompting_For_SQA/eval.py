...
def load(
    ...
    model_args: ModelArgs = ModelArgs(
        max_seq_len=max_seq_len, max_batch_size=max_batch_size,hidden_proj=hidden_proj, insert_layer=insert_layer, **params
    )
...
def main(
    ...
    generator = load(
        ...
        temperature, use_vicuna, insert_layer, bits=bits, cpu_load=cpu_load)
